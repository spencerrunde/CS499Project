...
const port = 3000; // Setting default port for backend to 3000
...
http.createServer(app).listen(port); // Creating backend server
console.log("Backend is running on port:", port); // Log to console
